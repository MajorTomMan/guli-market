-- Active: 1688392670869@@192.168.253.131@3306@gulimall_oms
-- 菜单

drop database if exists renren_security;

create database if not EXISTS renren_security default CHARACTER set utf8mb4;
...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES (5, 1, 'SQL监控', 'http://192.168.253.131:8080/renren-fast/druid/sql.html', NULL, 1, 'sql', 4);
